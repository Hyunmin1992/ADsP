...
function C11(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null){
		...
		if(count==5){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
...
function C12(name,phone){
	...
	if(A1==null|A2==null){
		...
		if(count==2){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C13(name,phone) {
	...
	if(A21==null|A22==null|A23==null|A24==null|A25==null|A26==null|A27==null|A1==null|A3==null|A4==null){
		...
		if(count==10){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C14(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null|A6==null|A7==null){
		...
		if(count==7){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C15(name,phone){
	...
	if(A1==null|A2==null|A3==null ||A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C16(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null){
		...
		if(count==5){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/6/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C17(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/7/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C18(name,phone){
	...
	if(A1==null|A2==null|A6==null|A3==null|A4==null|A7==null){
		...
		if(count==6){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/8/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C19(name,phone){
	...
	if(A1==null|A2==null){
		...
		if(count==2){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/9/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C110(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/10/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C111(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/11/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C112(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null|A6==null|A7==null|A10==null|A8==null|A9==null){
		...
		if(count==10){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/12/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C113(name,phone){
	...
	if(A1==null|A2==null|A31==null|A32==null|A4==null|A5==null|A6==null|A7==null|A8==null|A9==null){
		...
		if(count==9){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/1/13/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C21(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null|A6==null){
		...
		if(count==6){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/2/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C22(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null|A6==null|A7==null){
		...
		if(count==7){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/2/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C23(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/2/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C24(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null|A6==null){
		...
		if(count==6){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/2/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C25(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null|A5==null|A6==null|A7==null){
		...
		if(count==7){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/2/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C26(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null|A6==null|A7==null){
		...
		if(count==7){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/2/7/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C31(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/3/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C32(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/3/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C33(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/3/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C34(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null){
		...
		if(count==5){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/3/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C41(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null){
		...
		if(count==5){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C42(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C43(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null){
		...
		if(count==5){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C44(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null|A6==null){
		...
		if(count==6){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C45(name,phone){
	...
	if(A1==null|A2==null){
		...
		if(count==2){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C46(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/6/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C47(name,phone){
	...
	if(A1==null|A2==null){
		...
		if(count==2){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/7/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C48(name,phone){
	...
	if(A1==null|A2==null){
		...
		if(count==2){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/4/8/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C51(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/5/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C52(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/5/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C53(name,phone){
	...
	if(A1==null|A2==null){
		...
		if(count==2){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/5/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C54(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/5/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C55(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null|A6==null|A7==null){
		...
		if(count==7){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/5/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C56(name,phone){
	...
	if(A1==null|A2==null|A3==null |A4==null|A5==null|A6==null){
		...
		if(count==6){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/5/6/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C61(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/6/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C62(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/6/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C63(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/6/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C64(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(A3=='MA'|A3=='ma'|A3=='이동평균'|A3=='이동평균모형'|A3=='MA모형'|A3=='MA모델'|A3=='ma모형') {
			count=count+1;
		}
		if(count==3){
			alert("모두 맞았습니다.")
...
function C65(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/6/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C71(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/7/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C72(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/7/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C73(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/7/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C74(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/7/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C75(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/7/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C76(name,phone){
	...
	if(A1==null|A2==null|A3==null|A61==null|A62==null|A63==null|A64==null|A65==null|A66==null|A67==null){
		...
		if(count==10){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/7/6/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C81(name,phone){
	...
	if(A11==null|A12==null|A13==null|A21==null|A22==null|A23==null){
		...
		if(count==6){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/8/1/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C82(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/8/2/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C83(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/8/3/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C84(name,phone){
	...
	if(A1==null|A2==null|A3==null|A4==null){
		...
		if(count==4){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/8/4/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
...
function C85(name,phone){
	...
	if(A1==null|A2==null|A3==null){
		...
		if(count==3){
			alert("모두 맞았습니다.")
			axios.put("http://localhost:8000/DAY/8/5/"+name+"/"+phone)
		    .then(resData => {
		               console.log(resData);
		    }).catch(error => {
						console.log("비정상 응답 ", error);
